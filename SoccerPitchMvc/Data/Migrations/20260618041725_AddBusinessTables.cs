    ...
    public partial class AddBusinessTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Customer__3214EC0788E3795B", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternateName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Pitches__3214EC07DC791CA5", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TimeSlot__3214EC071DF07EBE", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimeSlots_Pitches",
                        column: x => x.PitchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Bookings__3214EC07796A9E90", x => x.Id);
                    table.ForeignKey(
